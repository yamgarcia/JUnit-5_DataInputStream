...
public class ConstantPoolEntryInterfaceMethod extends ConstantPoolEntry {
    private final static int SLOTS = 1;
    private int value1;
    private int value2;

    public ConstantPoolEntryInterfaceMethod(DataInputStream stream)
            throws IOException,
    ...
    public ConstantPoolType getType() {
        return ConstantPoolType.INTERFACE_METHOD;
    }
}
